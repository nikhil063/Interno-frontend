  ...
  return (
    <>
      ...
      <div style={{ paddingLeft: "200px" }}>
        ...
        <h1 style={{ fontFamily: "DM serif display", fontSize: "50px", fontWeight: "400", margin: "200px 380px 0px" }} >Latest Post</h1>

        <div style={{ display: "flex", margin: "0px 380px 200px" }}>
      ...
      <div>
        <h1 style={{ fontFamily: "DM serif display", fontSize: "50px", fontWeight: "400", marginLeft:"582px" }} >Article & News</h1>
